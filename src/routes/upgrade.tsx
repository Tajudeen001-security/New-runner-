    ...
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      {!isPro && (
        <div className="mx-auto mt-10 max-w-md rounded-xl border border-border/60 bg-card/40 p-5 text-center">
          <p className="text-sm font-medium">Prefer to pay by bank transfer or mobile money?</p>
          <p className="mt-1 text-xs text-muted-foreground">
            Message us to arrange payment — we'll send you a license code to activate Pro instantly.
          </p>
          <div className="mt-3 flex flex-wrap justify-center gap-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1.5 rounded-md border border-border px-3 py-2 text-xs font-medium hover:border-gold/60"
            >
              WhatsApp: 0916 065 4415
            </a>
            <a
              href="mailto:jrilicense@gmail.com"
              className="inline-flex items-center gap-1.5 rounded-md border border-border px-3 py-2 text-xs font-medium hover:border-gold/60"
            >
              jrilicense@gmail.com
            </a>
            <a
              href="mailto:jagwazorld@gmail.com"
              className="inline-flex items-center gap-1.5 rounded-md border border-border px-3 py-2 text-xs font-medium hover:border-gold/60"
            >
              jagwazorld@gmail.com
            </a>
          </div>

          <div className="mt-5 border-t border-border/60 pt-4">
            <p className="text-sm font-medium">Already got a code?</p>
